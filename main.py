...
async def predict(
    ...
    if language == "si":
        if plant == "Tomato":
            ...
            solution = disease_solution_Tomato_Si.get(predicted_class, "No solution found.") # Get the solution for the predicted disease from the dictionary
            ...
            solution = disease_solution_Corn_Si.get(predicted_class, "No solution found.")
            ...
            solution = disease_solution_Sugarcane_Si.get(predicted_class, "No solution found.")
            ...
            solution = disease_solution_Tea_Si.get(predicted_class, "No solution found.")
            ...
            solution = disease_solution_Grape_Si.get(predicted_class, "No solution found.")
            ...
            solution = disease_solution_Potato_Si.get(predicted_class, "No solution found.")
...
disease_solution_Tomato_Si = {
     "Tomato___Bacterial_spot": "භෝග භ්‍රමණය, සනීපාරක්ෂාව, ජල කළමනාකරණය, දිලීර නාශක, ප්‍රතිරෝධී වර්ග, ජෛව පාලන සහ නිසි පාංශු පෝෂණය අනුගමනය කරන්න. තඹ දිලීර නාශක බැක්ටීරියා ලප වළක්වන අතර ප්‍රතිරෝධී ප්‍රභේද සහ හිතකර බැක්ටීරියා ජෛව පාලනයට උපකාරී වේ. නිසි පාංශු පෝෂණය ශාක වර්ධනයට සහ ප්‍රතිරෝධයට සහාය වේ. ",
     "Tomato___Early_blight": "බෝග භ්‍රමණය ක්‍රියාත්මක කිරීම, ප්‍රමාණවත් පරතරයක් තැබීම, පාමුල ජලය දැමීම සහ කප්පාදු කිරීමේ ක්‍රම මගින් මුල් අංගමාරය පාලනය කිරීමට උපකාරී වේ. තෙත් කොළ වලින් වැළකී සිටිය යුතුය, ඒවා අංගමාරය දිරිමත් කළ හැකිය. ස්වාභාවික තඹ දිලීර නාශක, ක්ලෝරෝතලෝනිල් හෝ මැන්කොසෙබ් භාවිතා කළ හැකිය. පාලනය සඳහා පත්‍ර ඉසින හෝ කැටිති.",
     ...
     "Tomato___Septoria_leaf_spot": "භෝග භ්‍රමණය, නිසි ජලාපවහනය, පහළ කොළ කප්පාදු කිරීම, දිලීර නාශක භාවිතා කිරීම, රෝග-ප්‍රතිරෝධී ප්‍රභේද තෝරා ගැනීම, හොඳ වායු සංසරණය සැපයීම සහ සනීපාරක්ෂාව අනුගමනය කරන්න. බෝග කරකවන්න, අතු කප්පාදු කරන්න, සහ දිලීර වර්ධනය වැළැක්වීම සඳහා නිසි වායු සංසරණය සහතික කරන්න. බෝ වීම.",
     "Tomato___Spider_mites Two-spoder_spider_mites": "ජලය ඉසීම, නෙම් තෙල්, කෘමිනාශක සබන් සහ කොල්ලකාරී මයිටාවන්ට තක්කාලි පැල වලින් මකුළු මයිටාවන් තුරන් කළ හැක. නෙම් තෙල් මයිටා ජීවන චක්‍ර කඩාකප්පල් කරන අතර, කෘමිනාශක සබන් සතිපතා ඒවා විනාශ කරයි. විලෝපික මයිටාවන් පෝෂණය කරයි. ජීව විද්‍යාත්මක පාලනය",
     ...
     "Tomato___healthy": "කිසිදු රෝගයක් අනාවරණය වී නොමැත. ඔබේ තක්කාලි පැළය සෞඛ්‍ය සම්පන්නයි!",
}
disease_name_Tomato = {
...
disease_solution_Corn_Si = {
     ...
     "Corn__healthy": "කිසිදු රෝගයක් අනාවරණය වී නොමැත. ඔබේ ශාකය සෞඛ්‍ය සම්පන්නයි!",
}
disease_name_Corn = {
...
disease_solution_Tea_Si = {
     ...
     "Tea__healthy": "කිසිදු රෝගයක් අනාවරණය වී නොමැත. ඔබේ ශාකය සෞඛ්‍ය සම්පන්නයි!",
...
disease_solution_Grape_Si={
     ...
     "Grape__healthy": "කිසිදු රෝගයක් අනාවරණය වී නොමැත. ඔබේ ශාකය සෞඛ්‍ය සම්පන්නයි!",
...
disease_solution_Potato_Si={
     ...
     "Potato__healthy":"කිසිදු රෝගයක් අනාවරණය වී නොමැත. ඔබේ ශාකය සෞඛ්‍ය සම්පන්නයි!",
